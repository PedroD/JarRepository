...
/**
 * This is the perspective used for the Standard version in Operator mode.<br/>
 * This is based on the marketing functionalities version and operations mode.
 */
public class OperatorPerspective implements IPerspectiveFactory {

	/**
	 * Perspective identifier.
	 */
	public static final String PERSPECTIVE_ID = "lumina.perspectives.OperatorPerspective"; //$NON-NLS-1$
