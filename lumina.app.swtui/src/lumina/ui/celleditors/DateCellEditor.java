...
public class DateCellEditor extends CellEditor {
	...
	protected void doSetValue(Object value) {
		...
		text.setFormatter(new DateTimeFormatter(
				DatePropertyType.LOCALE_DATE_INPUT_FORMAT));
	...
	/**
	 * Gets layout of the cell editor.
	 * 
	 * @return a layout without minimum size. ince a text editor field is
	 *         scrolable we don't set a minimumSize.
	 */
	 ...
	 * 
	 * @return <code>true</code> if the current selection is not empty.
	 */
	 ...
	 * <code>CellEditor</code>.
	 * 
	 * @return <code>true</code> if there is a selection or if the caret is not
	 ...
	 * {@link CellEditor#dependsOnExternalFocusListener()}.
	 * 
	 * @return <code>false</code> if the current instance's class is
	 *         TextCellEditor, and <code>true</code> otherwise. Subclasses that
	 *         hook their own focus listener should override this method and
	 *         return <code>false</code>.
	 */
	protected boolean dependsOnExternalFocusListener() {
		return getClass() != DateCellEditor.class;
	}
}
